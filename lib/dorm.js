...
dorm.update = function (entity, handler) {
    ...
    query = dialect.buildUpdateQuery(entity, options);
    
    _singleEntityQuery(query, entity, handler);
}

dorm.update_set_values = function (entity, options, handler) {
    var container = {};
    if (options === undefined) {
        options = {};
    } else if (options instanceof Number || options instanceof String) {
