		...
		Object.defineProperty(this, name, {
			...
			set: function (value) {
				if(isCorrectType(value, Field)) {
					if(Field.primaryKey && !Field.allowManualAssignment) {
						throw new Error('FieldError: Should you really be assigning a value to a primary key?');
					} else {
...
Object.defineProperty(Entity, 'create', {
	...
	value: function (options) {
		...
		if(this.hasOwnProperty('table') && this.hasOwnProperty('type') && !this.instance) {
